...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    hero: Schema.Attribute.Component<
      'sections.landing-page-hero-section',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiMarketMarket extends Struct.SingleTypeSchema {
  collectionName: 'markets';
  info: {
    description: 'A market with carousel items.';
    displayName: 'Market';
    pluralName: 'markets';
    singularName: 'market';
  };
  ...
  attributes: {
    carousel: Schema.Attribute.Component<'sections.market-carousel', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRefundPolicyRefundPolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    refundAndReturn: Schema.Attribute.Component<
